...
import com.test.passcrypt.ui.password.PasswordViewModel;
...
public class Home extends AppCompatActivity {
    ...
    String repo = "https://github.com/toxicspirits/PassCrypt.git";
    String pack = "PassCrypt";
...
//        App updater
    ...
    protected void onStart() {
        ...
        if (sharedPreferences.getBoolean("FIRSTNOTICE", true)) {
            ...
            alertDialogBuilder.setMessage("PassCrypt is still in beta you may face some issues.");
            //Positive button
